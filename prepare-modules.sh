...
# 
# mscHack - no git repo
# Bidoo - v1.0 simde-ify patch (needs to reference plugin.mk with -mfpu=neon - TODO) - still buggy


# old stuff - can be deleted
#Fundamental - v1 patch
#AudibleInstruments - v1
#Befaco - v1
#ESeries - v1
#SquinkyVCV - master simde-ify
#BogaudioModules - v1
#ValleyRackFree - v1.0 patch simde-ify
#ML_modules - v1 simde-ify
#ImpromptuModular - v1
#STS - v1
#JW-Modules - v1
#surge-rack - release/1.beta1.0 patch (after submodule in surge dir) simde-ify
#AS - master
#Geodesics - v1
#vcv-link - feature/v1
#synthkit - v1.0
...
#cf - v1
#
# TODO: special treatment required: Fundamental - patch, SquinkyVCV - simdeify, BogaudioModules - v1 branch
#                                   ValleyRackFree - simdeify, ML_modules - simdeify, STS - V1 branch
#                                   surge-rack - simdeify, JW-Modules - v1 branch
# simdeify: find dir -type f -exec ../../../simde-ify.sh {} \;
# TODO: still missing in the plugin list above: https://github.com/ValleyAudio/ValleyRackFree.git - branch v1.0
# patch: Valley-simde-compile-hack.patch
# git clone https://github.com/martin-lueders/ML_modules.git - branch: v1
# git clone https://github.com/MarcBoule/ImpromptuModular.git - branch: v1
# git clone https://github.com/surge-synthesizer/surge-rack.git - branch: release/1.beta1.0
# git clone https://github.com/cfoulc/cf.git - branch v1
# git clone https://github.com/sebastien-bouffier/Bidoo.git - branch v1.0
# surge-rack requires surge-rack-surge.armv7l.patch after submodule checkout in surge subdir
# surge-rack requires make dist target to build a zip to install - otherwise surge-data is missing
